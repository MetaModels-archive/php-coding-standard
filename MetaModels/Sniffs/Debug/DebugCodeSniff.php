 ...
 * @link      http://pear.typo3.org
 */
class MetaModels_Sniffs_Debug_DebugCodeSniff implements PHP_CodeSniffer_Sniff {
    /**
        ...
        switch ($tokenType) {
            case 'T_STRING':
                if ($currentToken === 'debug') {
                    ...
                    if (($tokens[$previousToken]['content'] === '->') || ($tokens[$previousToken]['content'] === 'class') || ($tokens[$previousToken]['content'] === 'function')) {
