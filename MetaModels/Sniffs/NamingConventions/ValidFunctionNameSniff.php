 ...
 ***************************************************************/
/**
 * Based on the ValidFunctionNameSniff from TYPO3 ruleset.
 *
 * PHP version 5
 * TYPO3 version 4
 *
 ...
 * @link      http://pear.typo3.org
 */
class MetaModels_Sniffs_NamingConventions_ValidFunctionNameSniff implements PHP_CodeSniffer_Sniff
{
	/**
	...
	public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
	{
		...
		if ($hasUnderscores !== FALSE) {
			...
			if ($this->checkAllowedAcronyms($tokens[$functionName]['content'])) {
				return;
			}
	...
	protected function checkAllowedAcronyms($functionName)
	{
